...
handle_Locations:
	...
	/* handler: j.Locations type=[]*structs.Location kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			j.Locations = []*Location{}

			wantVal := true

			for {

				var tmpJLocations *Location
				...
				/* handler: tmpJLocations type=*structs.Location kind=ptr quoted=false*/
...
handle_Users:
	...
	/* handler: j.Users type=[]*structs.User kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJUsers type=*structs.User kind=ptr quoted=false*/
...
handle_Visits:
	...
	/* handler: j.Visits type=[]*structs.Visit kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJVisits type=*structs.Visit kind=ptr quoted=false*/
